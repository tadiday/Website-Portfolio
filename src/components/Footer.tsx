...
const Footer = () => {
  ...
  return (
    <footer className="pb-25 sm:pb-0 grid gap-x-4 gap-y-5 sm:gap-y-20 grid-cols-2 sm:grid-cols-[repeat(20,minmax(0,1fr))] md:grid md:grid-cols-14 text-[#80776d] pt-16">
