...
const NavBar = () => {
  return (
    <nav className="z-10 flex items-center justify-center w-full shadow-lg sm:rounded-tr-2xl sm:rounded-br-2xl bg-bar ">
      <div className="flex flex-row sm:flex-col items-center my-4">
        <ul className="text-[20px] flex flex-row sm:flex-col gap-y-6 items-center font-thin text-black">
