...
const Experience = (() => {
  ...
  return (
    <div id="experience" className="h-full min-h-[500px] bg-[#080807] p-4 rounded-b-[25px] flex flex-col items-center z-10 text-[#e8e8e3]">
      {/* Button Group */}
      ...
      < div className="relative z-20 w-full bg-secondary-400 overflow-x-clip" >
        ...
        <section className='pr-[5%] pb-[5%] pl-[5%] rounded-b-3xl min-h-[2000px] text-home '>
